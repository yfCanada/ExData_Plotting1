...
# Plot fourth figure;  Print to png File
png(file = "plot4.png")
par(mfrow = c(2,2),mar=c(4,4,1,1))
plot(data4$DateTime, data4$Global_active_power,type="l",ylab="Global Active Power",xlab="")
plot(data4$DateTime, data4$Voltage,type="l",ylab="Voltage",xlab="datetime")
plot(data4$DateTime, data4$Sub_metering_1,type="l",ylab = "Energy sub metering", xlab = "")
